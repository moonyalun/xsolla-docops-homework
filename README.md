...
[4.1.1. Инициализирующий запрос](#411-инициализирующий-запрос)

[4.1.2. Выбор покупки](#412-выбор-покупки)

[4.1.2.1. Покупка за реальную валюту](#4121-покупка-за-реальную-валюту)

[4.1.2.2. Покупка за виртуальную валюту](#4122-покупка-за-виртуальную-валюту)
