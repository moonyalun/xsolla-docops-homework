...
[3.1. Серверная интеграция](#серверная-интеграция)

[3.2. Упрощённая интеграция](#упрощённая-интеграция)

[4. Процесс работы сервиса](#4-процесс-работы-сервиса)

[4.1. Общая схема работы](#общая-схема-работы)

[4.1.1. Инициализирующий запрос](#инициализирующий-запрос)

[4.1.2. Выбор покупки](#выбор-покупки)

[4.1.2.1. Покупка за реальную валюту](#покупка-за-реальную-валюту)

[4.1.2.2. Покупка за виртуальную валюту](#покупка-за-виртуальную-валюту)
...
#### 4.1.2.1. Покупка за реальную валюту
...
#### 4.1.2.2. Покупка за виртуальную валюту
