...
[настроек](https://docs.google.com/document/d/1gkqvf-70VZHFr3O0LbyK6VzTYDlng5b43ewYcwWszlA/edit#heading=h.1qvv5bfeuj61)`("settings")`: `"goods_at_first"`, `"pricepoints_at_first"`, `"subscriptions_at_first"`, их значения могут быть 0 или 1.
