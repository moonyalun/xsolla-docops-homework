...
Здесь приведено описание SDK – библиотеки, которая реализует функционирование магазина на основе Paystation API. 

Предназначена для упрощения использования платежного решения Xsolla разработчиками альтернативных платформ.
